...
class Book:
    ...
    # gives us chance to perform any operations on the value b4 it gets returned. 
...
# trying to access the attribute which is not present 
print(b1.randomprop)